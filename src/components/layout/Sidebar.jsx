...
// Nav items map 1:1 to the platform's modules (Module 1-4 in the
// project brief), so update the `path` values once Member 1 /
// Member 7 finalize the real routes + API endpoints.
const NAV_ITEMS = [
